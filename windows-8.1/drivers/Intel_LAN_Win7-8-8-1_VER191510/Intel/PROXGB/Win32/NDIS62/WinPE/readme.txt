...
2. Copy all files from the PROXGB\Win32\NDIS6x\WinPE directory to the temporary directory.

3. Use the /Add-Driver option of the DISM.exe tool to import the drivers into the image. For example, use the following command:
